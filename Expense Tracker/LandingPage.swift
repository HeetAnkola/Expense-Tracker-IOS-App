    ...
    var body: some View {
        NavigationView {
            ZStack {
                ...
                // Main content before navigation
                VStack {
                    ...
                    ZStack(alignment: .center) {
                        ...
                        RoundedRectangle(cornerRadius: boxExpanded ? 0 : 30)
                            ...
                            .offset(y:40)
                            .animation(.easeInOut(duration: 0.2), value: boxExpanded)
                ...
                // Fade-in effect for the next screen's content once the white box expands
                if boxExpanded {
                    HomeScreen()
                        .transition(.opacity)
                        .onAppear {
                            withAnimation(.easeIn(duration: 0.2)) {
                                // Any additional logic for the next screen appearance
